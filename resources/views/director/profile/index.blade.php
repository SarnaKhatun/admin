                            ...
                            <div class="employee__history__photo">
                                @if ($user->image)
                                    <img
                                        ...
                                        src="{{ asset('backend/images/director/'.$user->image) }}"
                                        alt="no image">
                                @else
            ...
            <div class="row ">
                <div class="col-xl-6 offset-md-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('director.update-profile')}}" method="post" id="basicform"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                            ...
                                            <input id="designation" type="text" name="occupation"
                                    ...
                                    <div class="col-12">
                                        ...
                                        @if(Auth()->user()->image)
                                            <img
                                                src="{{ asset('backend/images/director/'.Auth()->user()->image) }}"
                                    ...
                                    <div class="col-12 mt-3">
                                        <div class="form-group from_group_mobile">
                                            ...
                                            <textarea name="present_address" id="address" cols="30"
                                                      class="form-control"
                                                      rows="2">{{ Auth::user()->present_address ?? "" }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
            ...
            <div class="row ">
                <div class="col-xl-6 offset-md-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('director.update-password')}}" method="post"
