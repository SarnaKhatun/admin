                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt- pb-0">
                                ...
                                <div class="ms-md-auto py-0 py-md-0">
                                    <a href="{{ route('director.monthly-subscription-fees.index')  }}" class="btn btn-primary btn-sm">Back List</a>
                                    <a href="{{ route('director.monthly-subscription-fee-ledger.pdf', $id)  }}" class="btn btn-info btn-sm">Download PDF</a>
