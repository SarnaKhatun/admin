                        ...
                        <div class="card-header">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt- pb-0">
                                <div class="ms-md-auto py-0 py-md-0">
                                    <a href="{{ route('director.membership-account') }}"
                                    ...
                                    <a href="{{ route('director.member-statement.pdf', $membershipAccount->id) }}"
                                        class="btn btn-info btn-sm">Download PDF</a>

                                    <a href="{{ route('director.single-page.member-statement.pdf', ['id' => $membershipAccount->id, 'page' => $memberStatements->currentPage()]) }}"
    ...
    <script>
        ...
        $('#filter').click(function() {
            ...
            window.location.href =
                "{{ route('director.member-account-statement.view', $membershipAccount->id) }}?start_date=" +
