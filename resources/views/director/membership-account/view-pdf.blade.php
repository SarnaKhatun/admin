        ...
        <tr>
            ...
            <td>
                @if ($membershipAccount->customer->image)
                    <img src="{{ public_path('backend/images/customer/' . $membershipAccount->customer->image) }}"
                        alt="Member Image">
                @else
        ...
        <tr>
            ...
            <td>
                @if ($membershipAccount->nominee_image)
                    <img src="{{ public_path('backend/images/membership-accounts/' . $membershipAccount->nominee_image) }}"
                        alt="Nominee Image">
                @else
                    <img src="{{ public_path('backend/images/no-image.png') }}" alt="No Image">
                @endif
        ...
        <tr>
            ...
            <td>
                @if ($membershipAccount->nominee_signature)
                    <img src="{{ public_path('backend/images/membership-accounts/' . $membershipAccount->nominee_signature) }}"
