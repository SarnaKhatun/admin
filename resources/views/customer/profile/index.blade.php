                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="employee__history__photo">
                                @if ($user->image)
                                    <img
                                        style="height: 120px;width: 120px;border-radius: 50%; margin-left: 170px"
                                        src="{{ asset('backend/images/customer/'.$user->image) }}"
                                        alt="no image">
                                @else
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between">
                                    ...
                                    <span>{!! $user->present_address_en ?? '' !!}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row ">
                <div class="col-xl-6 offset-md-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('customer.update-profile')}}" method="post" id="basicform"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
                                            ...
                                            <input id="mobile_number" type="text" name="phone"
                                    ...
                                    <div class="col-12">
                                        ...
                                        @if(Auth()->user()->image)
                                            <img
                                                src="{{ asset('backend/images/customer/'.Auth()->user()->image) }}"
                                                id="imagePreview" alt="image"
                                                style="height: 80px; width: 80px" class="ps-3 custom-img">
                                        @else
                                            <img src="{{ url('backend/images/no-image.png') }}"
                                                 id="imagePreview" alt="customer" width="50" class="ps-3">
                                        @endif
                                    </div>
                                    <div class="col-12 mt-3">
                                        <div class="form-group from_group_mobile">
                                            <label for="phone">Address </label>
                                            <textarea name="present_address_en" id="address" cols="30"
                                                      class="form-control"
                                                      rows="2">{{ Auth::user()->present_address_en ?? "" }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('customer.update-password')}}" method="post"
                                  id="basicform" data-parsley-validate="" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group from_group_mobile">
